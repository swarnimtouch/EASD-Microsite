...
@section('content')
    <div class="content d-flex flex-column flex-column-fluid medihub-user-form" id="kt_content">
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="medihub-page-heading">
                    <div><div class="medihub-eyebrow">Dashboard / User Management</div><h1>{{ isset($user) ? 'Edit HCP Profile' : 'Create New HCP' }}</h1><p>{{ isset($user) ? 'Update account details and portal access.' : 'Add a healthcare professional to the directory.' }}</p></div>
                </div>
                <div class="card">
                        ...
                        <div id="kt_user_wrapper" class="collapse show">
                            <form method="POST"
                                ...
                                <input type="hidden" name="has_existing_avatar" id="has_existing_avatar"
                                       value="{{ isset($user) && $user->profile_image ? '1' : '0' }}">
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="image-input image-input-outline"
                                                        ...
                                                        <div class="image-input-wrapper w-125px h-125px"
                                                             id="avatarPreview"
                                                             style="background-image: url('{{ $user->profile_image?? asset('assets/media/avatars/blank.png') }}')">
                                                        </div>
                                ...
                                <div class="card-footer d-flex justify-content-end py-6 px-9">
                                    <a href="{{ route('admin.user.index') }}"
                                       class="mh-btn-secondary me-2">Cancel</a>
                                    <button type="submit" class="mh-btn-primary" id="kt_user_submit">
