...
@section('content')
    <div class="content d-flex flex-column flex-column-fluid medihub-listing" id="kt_content">
        <!--begin::Post-->
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="medihub-page-heading">
                    <div><div class="medihub-eyebrow">Dashboard / User Management</div><h1>HCP User Directory</h1><p>Manage healthcare professionals and their portal access.</p></div>
                </div>
                <!--begin::Card-->
                <div class="card">
                    <!--begin::Card header-->
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <!--begin::Export-->
                                <button type="button" class="mh-btn-secondary me-3" id="export-btn">
                                ...
                                <!--begin::Add user-->
                                <a href="{{ route('admin.user.create') }}" class="mh-btn-primary">
                                    <span class="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                             viewBox="0 0 24 24" fill="none">
                ...
                userTable = $('#kt_table_users').DataTable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render: id => `
                    <div>
                        <a href="/admin/user/${id}" class="inline-flex h-8 w-8 items-center justify-center rounded-lg text-slate-400 transition-colors hover:bg-cyan-50 hover:text-brand-teal" title="View"><i class="bi bi-eye"></i></a>
                        <a href="/admin/user/${id}/edit" class="inline-flex h-8 w-8 items-center justify-center rounded-lg text-slate-400 transition-colors hover:bg-cyan-50 hover:text-brand-teal" title="Edit"><i class="bi bi-pencil-fill"></i></a>
                        <button class="delete-user inline-flex h-8 w-8 items-center justify-center rounded-lg border-0 bg-transparent text-slate-400 transition-colors hover:bg-rose-50 hover:text-brand-coral" data-id="${id}" title="Delete"><i class="bi bi-trash"></i></button>
                    </div>`
                        }
                    ]
                });
