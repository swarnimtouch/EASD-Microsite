                    ...
                    try {
                        ...
                        if (data.success) {
                            ...
                            if (data.errors) {
                                ...
                                document.getElementById('kt_sign_in_error_message').textContent = data.message || "Please check your details and try again.";
                                s.classList.remove('d-none');
                            }
                        }
                    } catch (error) {
                        console.error('Login error:', error);
                        document.getElementById('kt_sign_in_error_message').textContent = "An error occurred. Please try again.";
                        s.classList.remove('d-none');
                    } finally {
