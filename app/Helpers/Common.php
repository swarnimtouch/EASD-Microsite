    ...
    if ($user_type == 'admin') {
        $module = [
            ...
            [
                ...
                'child' => [],
                'all_routes' => ['admin.doctors', 'admin.doctors.add_edit_form']
            ],

            [
                'route' => route('admin.webinars'),
                'name' => 'Webinars',
                'icon' => 'bi bi-camera-video fs-3',
                'child' => [],
                'all_routes' => ['admin.webinars', 'admin.webinars.add_edit_form']
            ],

            [
                'route' => route('admin.webinar_comments'),
                'name' => 'Webinar Comments',
                'icon' => 'bi bi-chat-left-text fs-3',
                'child' => [],
                'all_routes' => ['admin.webinar_comments']
            ],

            [
                'route' => route('admin.certificates'),
                'name' => 'Certificates',
                'icon' => 'bi bi-award fs-3',
                'child' => [],
                'all_routes' => ['admin.certificates', 'admin.certificates.edit']
            ],

            [
                'route' => route('admin.modules'),
                'name' => 'Modules',
                'icon' => 'bi bi-journal-richtext fs-3',
                'child' => [],
                'all_routes' => ['admin.modules', 'admin.modules.add_edit_form']
            ],

            [
                'route' => route('admin.countries'),
                'name' => 'Countries',
                'icon' => 'bi bi-globe-asia-australia fs-3',
                'child' => [],
                'all_routes' => ['admin.countries', 'admin.countries.add_edit_form']
            ],

            [
                'route' => route('admin.specialities'),
                'name' => 'Specialities',
                'icon' => 'bi bi-heart-pulse fs-3',
                'child' => [],
                'all_routes' => ['admin.specialities', 'admin.specialities.add_edit_form']
            ],
            ...
            [
                ...
                'child' => [
                    ...
                    [
                        'route' => route('admin.faqs'),
                        'name' => 'FAQ',
                        'icon' => 'bi bi-question-circle',
                        'all_routes' => ['admin.faqs', 'admin.faqs.add_edit_form']
                    ]
                ],
                'all_routes' => [
                    'admin.settings',
                    'admin.content', 'admin.content.add_edit_form',
                    'admin.faqs', 'admin.faqs.add_edit_form'
                ]
            ]
        ];
    }
...
function is_active_header_menu($name): string
{
    $current = Route::currentRouteName();
